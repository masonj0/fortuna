...
class FortunaDesktopApp {
  ...
  async initialize() {
    // UI First: Create the window and tray immediately.
    ...
    try {
      ...
      await this.startBackend();
        ...
        dialog.showErrorBox(
            'Backend Error',
            `The backend service failed to start: ${error.message}. The UI will remain active, but data will be unavailable.`
        );
        // Do not quit the app. The UI is already running.
    }
  }
